...
export type FieldValidationResolverConfig<Root, Args, Context, Info> = {
  root: Root
  args: Args
  ctx: Context
  info: Info
...
export type FieldValidationResolver<R = any, A = any, C = any, I = any> = (
  yup: yupType,
  config: FieldValidationResolverConfig<R, A, C, I>,
) => yup.AnyObjectSchema
